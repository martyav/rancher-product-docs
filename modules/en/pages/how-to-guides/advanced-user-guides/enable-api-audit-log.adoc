...
* ../../reference-guides/single-node-rancher-in-docker/advanced-options.adoc#api-audit-log[Docker Install]
* ../../getting-started/installation-and-upgrade/installation-references/helm-chart-options.adoc#api-audit-log[Kubernetes Install]
