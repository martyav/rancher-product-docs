...
Resource quotas can also be set when a new project is created. For details, refer to the section on ../../../new-user-guides/manage-clusters/projects-and-namespaces.adoc#creating-projects[creating new projects.]
