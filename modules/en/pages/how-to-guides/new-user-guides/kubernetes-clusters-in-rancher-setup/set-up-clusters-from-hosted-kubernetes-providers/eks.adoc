...
For information on configuring the refresh interval, refer to ../../../../reference-guides/cluster-configuration/rancher-server-configuration/eks-cluster-configuration.adoc#configuring-the-refresh-interval[this section.]
