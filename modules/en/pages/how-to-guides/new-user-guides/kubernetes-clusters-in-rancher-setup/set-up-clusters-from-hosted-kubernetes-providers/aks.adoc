...
. Click *Create*.
. Click *Azure*.
. Fill out the form. For help with filling out the form, see the ../../../../reference-guides/cluster-configuration/rancher-server-configuration/aks-cluster-configuration.adoc#cloud-credentials[configuration reference.]
. Click *Create*.
