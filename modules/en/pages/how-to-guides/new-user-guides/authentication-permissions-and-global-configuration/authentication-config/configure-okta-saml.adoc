...
____
Before you proceed with the configuration, please familiarise yourself with authentication-config.adoc#external-authentication-configuration-and-principal-users[external authentication configuration and principal users].
____
