...
You can revise, share, and delete a template if you are an owner of the template. For details on how to become an owner of a template, refer to access-or-share-templates.adoc#sharing-ownership-of-templates[the documentation on sharing template ownership.]
...
. Optional: Share the template with other users or groups by access-or-share-templates.adoc#sharing-templates-with-specific-users-or-groups[adding them as members.] You can also make the template public to share with everyone in the Rancher setup.
...
* New clusters can be apply-templates.adoc#creating-a-cluster-from-an-rke-template[created from the new template and revision.]
