...
If admins have ../../../../api/api-tokens.adoc#disable-tokens-in-generated-kubeconfigs[kubeconfig token generation turned off], the kubeconfig file requires that the xref:./authorized-cluster-endpoint.adoc[Rancher CLI] to be present in your PATH.
