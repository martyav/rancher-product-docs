...
We recommend using a load balancer with the authorized cluster endpoint. For details, refer to the ../../../../reference-guides/rancher-manager-architecture/architecture-recommendations.adoc#architecture-for-an-authorized-cluster-endpoint-ace[recommended architecture section.]
