 ...
 ** Security group: `K8sMasterSg` More info at ../../../../getting-started/installation-and-upgrade/installation-requirements/port-requirements.adoc#downstream-kubernetes-cluster-nodes[RKE ports (custom nodes tab)]
 ** Tags:
...
* Security group: `K8sWorkerSg` More info at ../../../../getting-started/installation-and-upgrade/installation-requirements/port-requirements.adoc#downstream-kubernetes-cluster-nodes[RKE ports (custom nodes tab)]
* Tags:
 ** `kubernetes.io/cluster/<clusterID>: owned`
