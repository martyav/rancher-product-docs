...
If you don't find the node driver that you want to use, you can see if it is available in Rancher's built-in ../../authentication-permissions-and-global-configuration/about-provisioning-drivers/manage-node-drivers.adoc#activatingdeactivating-node-drivers[node drivers and activate it], or you can ../../authentication-permissions-and-global-configuration/about-provisioning-drivers/manage-node-drivers.adoc#adding-custom-node-drivers[add your own custom node driver].
...
For RKE2 cluster templates, please refer to ../../manage-clusters/manage-cluster-templates.adoc#rke2-cluster-template[this page] for additional information.
====
