...
* ../../how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/back-up-rancher-launched-kubernetes-clusters.adoc#how-snapshots-work[Backing up a cluster]
* ../../how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/restore-rancher-launched-kubernetes-clusters-from-backup.adoc#restoring-a-cluster-from-a-snapshot[Restoring a cluster from backup]
...
. Configure the options for how pods are deleted. For more information about each option, refer to ../../how-to-guides/new-user-guides/manage-clusters/nodes-and-node-pools.adoc#aggressive-and-safe-draining-options[this section.]
