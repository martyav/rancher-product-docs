...
If you want terminate SSL/TLS externally, see ../../installation-references/helm-chart-options.adoc#external-tls-termination[TLS termination on an External Load Balancer].
====
...
* ../../../../integrations-in-rancher/rancher-extensions.adoc#importing-and-installing-extensions-in-an-air-gapped-environment[Importing and installing extensions in an air-gapped environment]
