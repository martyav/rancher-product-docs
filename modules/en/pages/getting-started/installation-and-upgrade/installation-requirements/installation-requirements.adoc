...
If you install Rancher on a hardened Kubernetes cluster, check the ../../../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates.adoc#exempting-required-rancher-namespaces[Exempting Required Rancher Namespaces] section for detailed requirements.
