...
. ../reference-guides/user-settings/api-keys.adoc#creating-an-api-key[Create] a Rancher API key with no scope.
...
In this example, we'll show how to use kubectl to create a project, followed by deleting it. For a list of other Rancher resources available, refer to the ./api-reference.adocx[API Reference] page.
