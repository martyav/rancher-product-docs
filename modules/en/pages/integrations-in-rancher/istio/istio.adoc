...
Additional Istio Ingress gateways can be enabled via the configuration-options/configuration-options.adoc#overlay-file[overlay file].

=== Egress Support

By default the Egress gateway is disabled, but can be enabled on install or upgrade through the values.yaml or via the configuration-options/configuration-options.adoc#overlay-file[overlay file].
