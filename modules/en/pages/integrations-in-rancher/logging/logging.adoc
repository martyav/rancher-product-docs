...
You can logging-helm-chart-options.adoc#enabledisable-windows-node-logging[enable logging] from Windows nodes.

=== Working with a Custom Docker Root Directory

For details on using a custom Docker root directory, see logging-helm-chart-options.adoc#working-with-a-custom-docker-root-directory[this section.]
...
For information on enabling the logging application for SELinux-enabled nodes, see logging-helm-chart-options.adoc#enabling-the-logging-application-to-work-with-selinux[this section.]

=== Additional Logging Sources

By default, Rancher collects logs for control plane components and node components for all cluster types. In some cases additional logs can be collected. For details, see logging-helm-chart-options.adoc#additional-logging-sources[this section.]
