...
Some tests are designated as "Not Applicable." These tests will not be run on any CIS scan because of the way that Rancher provisions RKE clusters. For information on how test results can be audited, and why some tests are designated to be not applicable, refer to Rancher's ../../reference-guides/rancher-security/rancher-security.adoc#the-cis-benchmark-and-self-assessment[self-assessment guide] for the corresponding Kubernetes version.
...
In order to pass the "Hardened" profile, you will need to follow the steps on the ../../reference-guides/rancher-security/rancher-security.adoc#rancher-hardening-guide[hardening guide] and use the `cluster.yml` defined in the hardening guide to provision a hardened cluster.
