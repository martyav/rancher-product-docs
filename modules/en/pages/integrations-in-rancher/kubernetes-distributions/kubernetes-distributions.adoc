...
* Standard Rancher management of Kubernetes clusters including all outlined ../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.adoc#cluster-management-capabilities-by-cluster-type[cluster management capabilities].
