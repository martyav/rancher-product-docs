...
For information about role-based access control for Grafana, see rbac-for-monitoring.adoc#role-based-access-control-for-grafana[this section.]
...
This section assumes familiarity with how monitoring components work together. For more information about Alertmanager, see how-monitoring-works.adoc#3-how-alertmanager-works[How Alertmanager Works.]
====
